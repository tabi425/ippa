...
$site_top = "https://hhgrow.org/index.html";

//管理者のメールアドレス（送信先） ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "30606shimohara@gmail.com,smhr425@gmail.com";
...
$subject = "ホームページよりお問い合わせを受け付けました";
...
$thanksPage = "https://hhgrow.org/index.html";
...
$require = array('name','tel','mail','message');
...
お問い合わせありがとうございました。
担当者より、折り返しご連絡いたしますので、しばらくお待ちください。
